package com.cennavi.search.client.annotation;

import com.cennavi.search.client.client.feign.fallback.SearchServiceFallbackFactory;
import com.cennavi.search.client.client.service.impl.QueryServiceImpl;
...
@EnableFeignClients(basePackages = "com.cennavi.search")
