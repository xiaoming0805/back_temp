...
public class SearchBuilder {
     ...
     */
    public ESPageResult<JsonNode> getPage() throws IOException {
     ...
     * @param limit 每页显示
     */
    public ESPageResult<JsonNode> getPage(Integer page, Integer limit) throws IOException {
    ...
    private <T> void populateHighLightedFields(T result, Map<String, HighlightField> highlightFields) {
        for (HighlightField field : highlightFields.values()) {
            try {
                ...
                throw new GlobalException(500,"failed to set highlighted value for field: " + field.getName()
