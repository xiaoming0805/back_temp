...
public class WebPage {
    public WebPageResult getPageList(JdbcTemplate jdbcTemplate,String base_sql, List<Object> find_params, Integer page, Integer limit, Class Z){
       ...
       // System.out.println(sql);
        ...
        return  WebPageResult.builder().data(toBean(list,Z)).code(0).count(total).build();
    }
    /**
